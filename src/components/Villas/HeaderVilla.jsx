    ...
    <header className="relative h-[70vh] md:h-[85vh] overflow-hidden bg-slate-900">
      ...
      <nav className="relative z-20 max-w-6xl mx-auto px-6 pt-6 flex items-center justify-between">
        ...
        <div className="flex items-center space-x-2 bg-white/5 rounded-full px-2 py-1 backdrop-blur-sm">
          <button
            onClick={() => navigate("/villas/imagenes")}
            className={`px-4 py-2 rounded-full text-sm transition ${
              isActive("imagenes") ? "bg-white text-slate-900" : "text-white/90 hover:bg-white/10"
            }`}
          >
            Imágenes
          </button>
          ...
          <button
            onClick={() => navigate("/villas/plano")}
            className={`px-4 py-2 rounded-full text-sm transition ${
              isActive("plano") ? "bg-white text-slate-900" : "text-white/90 hover:bg-white/10"
            }`}
          >
            Plano
          </button>
          ...
          <button
            onClick={() => navigate("/villas/reservar")}
            className={`px-4 py-2 rounded-full text-sm transition ${
              isActive("reservar") ? "bg-white text-slate-900" : "text-white/90 hover:bg-white/10"
            }`}
          >
            Reservar
          </button>
      ...
      <div className="relative z-20 max-w-6xl mx-auto px-6 flex items-center justify-center h-full">
        <div className="text-center text-white">
          <h1 className="text-4xl md:text-6xl font-light drop-shadow-lg">Villas Exclusivas</h1>
